...
strikes (sid : integer, fid : integer, numbirds : integer, impact : text, damage : boolean, altitude : integer ≥ 0, conditions : {...}) 
...
#writing all the dataframes to tables
...
# replacing conditions with condition id
